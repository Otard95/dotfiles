...
vim.api.nvim_create_autocmd('User', {
  pattern = 'PlugLoaded',
  callback = TelescopeSetup,
})

function nvim_telescope_init(paqInit)
  table.insert(paqInit, { 'nvim-telescope/telescope.nvim', branch = '0.1.x' })
  -- table.insert(paqInit, { 'nvim-telescope/telescope-live-grep-args.nvim' })
end

return nvim_telescope_init
