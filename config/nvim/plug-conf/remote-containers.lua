-- function DevContainerGetStatus ()
...
function remote_containers_init(paqInit)
  table.insert(paqInit, 'https://codeberg.org/esensar/nvim-dev-container')
end

return remote_containers_init
